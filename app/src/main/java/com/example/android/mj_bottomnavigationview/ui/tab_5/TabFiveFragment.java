...
public class TabFiveFragment extends Fragment {
    ...
    private TabFiveViewModel tabFiveViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        tabFiveViewModel = ViewModelProviders.of(this).get(TabFiveViewModel.class);

        View root = inflater.inflate(R.layout.fragment_tab, container, false);

        ButterKnife.bind(this, root);

        tabFiveViewModel.getText().observe(this, s -> textView.setText(s));
